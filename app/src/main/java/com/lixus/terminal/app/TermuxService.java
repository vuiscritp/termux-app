...
import com.lixus.terminal.app.event.SystemEventReceiver;
import com.lixus.terminal.app.terminal.TermuxTerminalSessionActivityClient;
import com.lixus.terminal.app.terminal.TermuxTerminalSessionServiceClient;
import com.lixus.terminal.shared.termux.plugins.TermuxPluginUtils;
import com.lixus.terminal.shared.data.IntentUtils;
import com.lixus.terminal.shared.net.uri.UriUtils;
import com.lixus.terminal.shared.errors.Errno;
import com.lixus.terminal.shared.shell.ShellUtils;
...
import com.lixus.terminal.shared.termux.shell.TermuxShellUtils;
...
import com.lixus.terminal.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.lixus.terminal.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.lixus.terminal.shared.termux.shell.TermuxShellManager;
...
import com.lixus.terminal.shared.notification.NotificationUtils;
...
import com.lixus.terminal.shared.shell.command.ExecutionCommand.ShellCreateMode;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
     ...
     * the results forever like in case of commands started by com.lixus.terminal:Tasker or RUN_COMMAND intent,
     ...
     * be used, like in Tasker for the com.lixus.terminal:Tasker actions.
     *
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.lixus.terminal.shared.R.string.error_execution_cancelled))) {
