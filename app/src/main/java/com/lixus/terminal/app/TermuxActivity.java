...
import com.lixus.terminal.app.api.file.FileReceiverActivity;
import com.lixus.terminal.app.terminal.TermuxActivityRootView;
import com.lixus.terminal.app.terminal.TermuxTerminalSessionActivityClient;
import com.lixus.terminal.app.terminal.io.TermuxTerminalExtraKeys;
import com.lixus.terminal.shared.activities.ReportActivity;
import com.lixus.terminal.shared.activity.ActivityUtils;
import com.lixus.terminal.shared.activity.media.AppCompatActivityUtils;
import com.lixus.terminal.shared.data.IntentUtils;
import com.lixus.terminal.shared.android.PermissionUtils;
import com.lixus.terminal.shared.data.DataUtils;
import com.lixus.terminal.shared.termux.TermuxConstants;
import com.lixus.terminal.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.lixus.terminal.app.activities.HelpActivity;
import com.lixus.terminal.app.activities.SettingsActivity;
import com.lixus.terminal.shared.termux.crash.TermuxCrashUtils;
import com.lixus.terminal.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.lixus.terminal.app.terminal.TermuxSessionsListViewController;
import com.lixus.terminal.app.terminal.io.TerminalToolbarViewPager;
import com.lixus.terminal.app.terminal.TermuxTerminalViewClient;
import com.lixus.terminal.shared.termux.extrakeys.ExtraKeysView;
import com.lixus.terminal.shared.termux.interact.TextInputDialogUtils;
import com.lixus.terminal.shared.logger.Logger;
import com.lixus.terminal.shared.termux.TermuxUtils;
import com.lixus.terminal.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.lixus.terminal.shared.termux.theme.TermuxThemeUtils;
import com.lixus.terminal.shared.theme.NightMode;
import com.lixus.terminal.shared.view.KeyboardUtils;
import com.lixus.terminal.shared.view.ViewUtils;
                ...
                if(PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.lixus.terminal.shared.R.string.msg_storage_permission_granted_on_request));

                    TermuxInstaller.setupStorageSymlinks(TermuxActivity.this);
                } else {
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.lixus.terminal.shared.R.string.msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
