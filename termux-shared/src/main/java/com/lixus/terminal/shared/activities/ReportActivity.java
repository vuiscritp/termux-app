package com.lixus.terminal.shared.activities;
...
import com.lixus.terminal.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.lixus.terminal.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.lixus.terminal.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
