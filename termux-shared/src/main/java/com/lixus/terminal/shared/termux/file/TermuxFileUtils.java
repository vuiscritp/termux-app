package com.lixus.terminal.shared.termux.file;
...
import com.lixus.terminal.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.lixus.terminal` as secondary user will result
     * in `ls: /data/user/0/com.lixus.terminal: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.lixus.terminal` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.lixus.terminal` where `10` is
