package com.lixus.terminal.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.lixus.terminal.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.lixus.terminal/10xxx}
             */
