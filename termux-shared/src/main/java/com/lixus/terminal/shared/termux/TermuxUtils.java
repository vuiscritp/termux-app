...
import com.lixus.terminal.shared.reflection.ReflectionUtils;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.lixus.terminal`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.lixus.terminal/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.lixus.terminal" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    /**
     * Check if com.lixus.terminal:API app is installed and enabled. This can be used by external apps that don't
     * share `sharedUserId` with the com.lixus.terminal:API app.
     *
     * @param context The context for operations.
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.lixus.terminal.shared.R.raw.apt_info_script);
        try {
